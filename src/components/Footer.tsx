...
const Footer = () => {
  return (
    <footer className="bg-cab-deep-blue text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-xl mb-4 flex items-center">
              <div className="w-8 h-8 bg-gradient-to-r from-cab-purple to-cab-bright-blue rounded-lg flex items-center justify-center text-white font-bold mr-2 text-sm">CA</div>
              CabAI
            </h3>
            <p className="text-gray-300 text-sm">
              AI-powered cab booking platform for accurate predictions and seamless rides.
            </p>
          </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 text-sm mb-4 md:mb-0">
            © 2025 CabAI Navigator. All rights reserved.
          </div>
